...
export interface IZonesController {
    ...
    getZoneById(correlationId: string, zone_id: string, callback: (err: any, zone: ZoneV1) => void): void;
    ...
    deleteZoneById(correlationId: string, zone_id: string, callback: (err: any, zone: ZoneV1) => void): void;
